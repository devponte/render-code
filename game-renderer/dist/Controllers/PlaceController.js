...
const box = new QueueBox(`PlaceBox`, Config.Ports.RCC.Place);
router.post("/thumbnail", Valid(PlaceRenderRequest), async (req, res) => {
    ...
    return await box.Enqueue((port) => RequestRCCBase(req, res, xml, port, "Place thumbnail"));
});
